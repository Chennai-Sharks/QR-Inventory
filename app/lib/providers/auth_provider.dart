...
//   static Future<void> signIn({required BuildContext context}) async {
//     final closeLoading = VxToast.showLoading(context, msg: 'Signing In...');
//     final TextEditingController companyNameController = TextEditingController();
//     try {
...
//           throw Exception('Error doing Google Oauth. Try Later');
//         }
//         closeLoading();
...
//           print('here');
//           final checkResponseJSon = json.decode(checkResponse.body) as Map<String, dynamic>;
//           await AuthProvider.setAuthToken(checkResponseJSon['authToken']);
//           await AuthProvider.setCompanyName(checkResponseJSon['companyName']);
//           return;
//         }
//         print('hedre');
...
//         await AuthProvider.setAuthToken(responseData['authToken']);
//         print(responseData);
//         await AuthProvider.setCompanyName(responseData['companyName']);

//         /// [To send userData to the qr inventory server]
